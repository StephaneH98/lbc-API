...
###############################################
# Script de déploiement Lambda getUserSearches
# Crée un package sans polluer le dépôt Git
###############################################

echo "🚀 Début du déploiement de getUserSearches"
echo "=========================================="
...
cp "${SCRIPT_DIR}/get_user_searches.py" "$BUILD_DIR/"
